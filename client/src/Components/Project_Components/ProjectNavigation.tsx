...
import { ActionType, useProjectStore } from "../../Store/useProjectStore";
...
const Category = ({
	...
	const handleDelete = (id: string) => {
		projectDispatch({ type: ActionType.REMOVE_CATEGORY, category_id: id });
	};
	useEffect(() => {
		// If current categoryindex is the same as this index then calculate caret pos
